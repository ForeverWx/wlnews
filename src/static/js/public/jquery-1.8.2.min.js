...
(function (a, b) {
    ...
    var L, M, N, O = /[\t\r\n]/g, P = /\r/g, Q = /^(?:button|input)$/i,
        ...
        T = /^(?:autosubject|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
    ...
    var V = /^(?:textarea|input|select)$/i, W = /^([^\.]*|)(?:\.(.+)|)$/, X = /(?:^|\s)hover(\.\S+|)\b/, Y = /^key/,
        Z = /^(?:mouse|contextmenu)|click/, $ = /^(?:subjectinsubject|subjectoutblur)$/, _ = function (a) {
    ...
    p.event = {
        ...
        trigger: function (c, d, f, g) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                ...
                return c.type = s, !g && !c.isDefaultPrevented() && (!n._default || n._default.apply(f.ownerDocument, d) === !1) && (s !== "click" || !p.nodeName(f, "a")) && p.acceptData(f) && m && f[s] && (s !== "subject" && s !== "blur" || c.target.offsetWidth !== 0) && !p.isWindow(f) && (l = f[m], l && (f[m] = null), p.event.triggered = s, f[s](), p.event.triggered = b, l && (f[m] = l)), c.result
            }
            return
        },
        dispatch: function (c) {
        ...
        special: {
            load: {noBubble: !0},
            subject: {delegateType: "subjectin"},
            blur: {delegateType: "subjectout"},
            beforeunload: {
    ...
    }), p.support.subjectinBubbles || p.each({subject: "subjectin", blur: "subjectout"}, function (a, b) {
    ...
    }), p.each("blur subject subjectin subjectout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (a, b) {
        p.fn[b] = function (a, c) {
